...
class SneakerIDResponseBody:
    r"""Successful processing of image URL"""
...
class SneakerIDResponse:
    ...
    object: Optional[SneakerIDResponseBody] = dataclasses.field(default=None)
    r"""Successful processing of image URL"""
